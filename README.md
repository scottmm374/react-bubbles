...
_Answer_ - A token is used to authenticate a user, to access specified routes in our app.

- [ ] What steps can you take in your web apps to keep your data secure?

_Answer_ - Create a token that is stored for future use, and protected routes so that routes cannot be accessed without Autentication.

- [ ] Describe how web servers work.

_Answer_ - First your web browser the IP address of the requested Domain, then requests the full URL from the web server. Then the web server sends the desired pages back to your web browser which then displays the page.
